...
export const apiEndpoints = [
  ...
  'POST /api/v1/complaints/:id/appeals - 志愿者七日内提交申诉',
  'GET  /api/v1/complaints/appeals - 申诉列表(管理员)',
  'GET  /api/v1/complaints/appeals/:id - 申诉详情(管理员)',
  'POST /api/v1/complaints/appeals/:id/review - 审核申诉(管理员)',
