export const messages = {
  ...
  appeals: {
    notFound: '申诉不存在',
    forbidden: '只能为自己的投诉提交申诉',
    complaintNotResolved: '投诉未确认，无法申请复核',
    windowExpired: '已超出投诉确认后七日的复核申请期限',
    pendingExists: '该投诉已有待处理的申诉，请勿重复提交',
    alreadyHandled: '该申诉已处理',
    approved: '申诉已通过，相关积分与信用处罚已撤销',
    rejected: '申诉已驳回，原处罚不变',
    createFailed: '提交申诉失败',
    handleFailed: '处理申诉失败',
  },
  admin: {
  ...
  logs: {
    ...
    createAppealFailed: '提交申诉失败',
    handleAppealFailed: '处理申诉失败',
    adjustPointsFailed: '调整积分失败',
    adjustCreditFailed: '调整信用分失败',
